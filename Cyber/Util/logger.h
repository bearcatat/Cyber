...
#define TraceL cyber::LogContextCapturer(cyber::GetLogger(), cyber::LTRACE, __FILE__, __FUNCTION__, __LINE__, std::this_thread::get_id())
#define DebugL cyber::LogContextCapturer(cyber::GetLogger(), cyber::LDEBUG, __FILE__, __FUNCTION__, __LINE__, std::this_thread::get_id())
#define InfoL cyber::LogContextCapturer(cyber::GetLogger(), cyber::LINFO, __FILE__, __FUNCTION__, __LINE__, std::this_thread::get_id())
#define WarnL cyber::LogContextCapturer(cyber::GetLogger(), cyber::LWARN, __FILE__, __FUNCTION__, __LINE__, std::this_thread::get_id())
#define ErrorL cyber::LogContextCapturer(cyber::GetLogger(), cyber::LERROR, __FILE__, __FUNCTION__, __LINE__, std::this_thread::get_id())
#define WriteL(level) cyber::LogContextCapturer(cyber::GetLogger(), level, __FILE__, __FUNCTION__, __LINE__, std::this_thread::get_id())
